<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmHomeImagenesGenerales.aspx.cs" Inherits="CreativaSL.WebForms.Kymo.WebAdmin.frmHomeImagenesGenerales" %>
        ...
        <div class="col-sd-12">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h4 class="panel-title"><span class="text-bold">DATOS HOME GENERALES</span></h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-6">
                                    <input type="submit" formaction="frmHomeImagenesGenerales.aspx" class="btn btn-green btn-block" name="btnGuardar" value="Guardar"/>
                                </div>
                            </div>
                        </div>
                    </div>
