<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="frmNosotrosQuienesSomosGrid.aspx.cs" Inherits="CreativaSL.WebForms.Kymo.WebAdmin.frmNosotrosQuienesSomosGrid" %>
		...
		<div class="col-md-12">
			...
			<div class="panel panel-white">
				<div class="panel-heading">
					<h4 class="panel-title">Catálogo <span class="text-bold">Nosotros Quienes Somos</span></h4>
				</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-md-12 space20">
							<a href="frmNosotrosQuienesSomos.aspx" class="btn btn-green">
								Nuevo
