<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="frmCarritoComprasDatosGenerales.aspx.cs" Inherits="CreativaSL.WebForms.Kymo.WebAdmin.frmCarritoComprasDatosGenerales" %>
        ...
        <div class="col-sd-12">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h4 class="panel-title"><span class="text-bold">Carrito de Compras "Datos Generales"</span></h4>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <asp:HiddenField ID="hftxt1" runat="server" />
                        <asp:HiddenField ID="hftxt2" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <input type="submit" formaction="frmCarritoComprasDatosGenerales.aspx" class="btn btn-green btn-block" name="btnGuardar" value="Guardar" />
                                    </div>
                                    <div class="col-md-6">
                                        <a href="frmCarritoComprasDatosGenerales.aspx" class="btn btn-red btn-block" name="btnCancelar">Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
