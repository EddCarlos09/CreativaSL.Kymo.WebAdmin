<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmHomeBannerGrid.aspx.cs" Inherits="CreativaSL.WebForms.Kymo.WebAdmin.frmHomeBannerGrid" %>
		...
		<div class="col-md-12">
			<div class="panel panel-white">
                ...
                <div class="controls" style="padding-left:10px;">
                    <a href="frmHomeBanner.aspx" class="btn btn-green">Nuevo <i class="fa fa-plus"></i></a>
                </div>
                        ...
                        <% foreach (var Item in this.Lista)
                            {
                                string HTMLli = string.Format(@"<li class='col-md-3 col-sm-6 col-xs-12 mix category_1 gallery-img' data-cat='1'>
							                        <div class='portfolio-item'>
														...
														<a href='frmHomeBanner.aspx?op=2&id={3}'>
                                                    ...
                                                    <div class='modal-dialog modal-sm'>
		                                                <div class='modal-content'>
			                                                ...
			                                                <div class='modal-footer'>                     
                                                                ...
                                                                <a href='frmHomeBannerGrid.aspx?op=3&id={3}' class='btn btn-green add-row' runat='server'>Si</a>
                                                            </div>
		                                                </div>
	                                                </div>
