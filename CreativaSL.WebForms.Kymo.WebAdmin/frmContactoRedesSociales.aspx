<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmContactoRedesSociales.aspx.cs" Inherits="CreativaSL.WebForms.Kymo.WebAdmin.frmContactoRedesSociales" %>
            ...
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="cmbRedSocial" name="cmbRedSocial" class="form-control search-select">
                                    <option value=""></option>
                                    <% foreach (var Item in _ListaTipoRedSocial)
                                        {
                                            Response.Write("<option value='" + Item.IdTipoRedSocial + "'> " + Item.NombreRedSocial + "</option>");
                                        }%>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label" for="cph_MasterBody_txtNickName">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-6">
                                    <input type="submit" formaction="frmContactoRedesSociales.aspx" class="btn btn-green btn-block" name="btnGuardar" value="Guardar" />
                                </div>
                                <div class="col-md-6">
                                    <a href="frmContactoRedesSocialesGrid.aspx" class="btn btn-red btn-block" name="btnCancelar">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    </div>
