<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="frmAvisoPrivacidadDatosGenerales.aspx.cs" Inherits="CreativaSL.WebForms.Kymo.WebAdmin.frmAvisoPrivacidadDatosGenerales" %>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <input type="submit" formaction="frmAvisoPrivacidadDatosGenerales.aspx" class="btn btn-green btn-block" name="btnGuardar" value="Guardar" />
                                    </div>
                                    <div class="col-md-6">
                                        <a href="frmAvisoPrivacidadDatosGenerales.aspx" class="btn btn-red btn-block" name="btnCancelar">Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
