<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmContactoDatosG.aspx.cs" Inherits="CreativaSL.WebForms.Kymo.WebAdmin.frmContactoDatosG" %>
        ...
        <div class="col-sd-12">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h4 class="panel-title"><span class="text-bold">DATOS GENERALES CONTACTO</span></h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-6">
                                    <input type="submit" formaction="frmContactoDatosG.aspx" class="btn btn-green btn-block" name="btnGuardar" value="Guardar"/>
                                </div>
                                <div class="col-md-6">
                                    <a href="frmContactoDatosG.aspx" class="btn btn-red btn-block" name="btnCancelar">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    </div>
