<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" ValidateRequest="false" CodeBehind="frmAvisoPrivacidadAvisos.aspx.cs" Inherits="CreativaSL.WebForms.Kymo.WebAdmin.frmAvisoPrivacidadAvisos" %>
        ...
        <div class="col-sd-12">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h4 class="panel-title"><span class="text-bold">Aviso de Privacidad "Avisos"</span></h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <input type="submit" formaction="frmAvisoPrivacidadAvisos.aspx" class="btn btn-green btn-block" name="btnGuardar" value="Guardar" />
                                    </div>
                                    <div class="col-md-6">
                                        <a href="frmAvisoPrivacidadAvisosGrid.aspx" class="btn btn-red btn-block" name="btnCancelar">Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
